...
<div class="col-lg-12">
	<div class="card card-outline card-primary"> 
		...
		<div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Clearence Date</label>
        ...
        <div class="row">
           ...
           <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Port Manager</label>
      ...
      <?php endif; ?>
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Members In Charge</label>
		...
		<div class="row">
			<div class="col-md-10">
				<div class="form-group">
					<label for="" class="control-label">Items Description</label>
